        ...
        for param in group.params:
            ...
            if type_str.startswith("Enum"):
                ...
                if len(type_str) == 0:
                    ...
                    print_line(f'{spin_obj}->setMaximum(99999);')
                    print_line(f'{spin_obj}->setMinimum(-99999);')
                    ...
                    print_line(f'{first_spin_obj}->setMaximum(99999);')
                    print_line(f'{first_spin_obj}->setMinimum(-99999);')
                    ...
                    print_line(f'{second_spin_obj}->setMaximum(99999);')
                    print_line(f'{second_spin_obj}->setMinimum(-99999);')
